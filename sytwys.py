...
class   Sytwys( object):
    ...
    def __init__( self):
        ...
        self.sw_mdcp_kp_uwagi3  = "Dla obszaru w granicach projektowanej inwestycji budowlanej brak obciążeń z tytułu \nsłużebności gruntowych (§80 ust. 4. rozp. MSWiA z dnia 9 listopada 2011 r.)."
        ...
        self.sw_mdcp_kp_uwagi1_fraza2 = " mapy zasadniczej oraz\npomiaru aktualizacyjnego id. zgł. "
