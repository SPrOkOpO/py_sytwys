...
class SytwysGUIgrid( tk.Frame):
	...
	def inicjuj( self):
		...
		1)	najpierw sprawdzenie, czy podano dobry obręb
			-	jednocześnie jest to inicjacja pól obiektu teryt
		'''
		
		# 1)
		if	self.t.setTerytFrom_obrNazwa( self.v_sw_obreb.get()) != 0:
			tk.messagebox.showinfo("Err", "Inicjacja niudana - błędny obręb")
			return -1	
	...
	def btn_gen_uwagi1( self):	
		...
		self.sw.sw_mdcp_kp_uwagi1 = self.sw.sw_mdcp_kp_uwagi1 + " mapy zasadniczej oraz pomiaru aktualizacyjnego id. zgł. \n"
	...
	def btn_gen_uwagi2( self):	
		...
		self.sw.sw_mdcp_kp_uwagi2 = "Dane dotyczące działki "
		...
		if self.sw.sw_mdcp_ust5_str == "1" and self.sw.sw_mdcp_ust6_str == "1":
			self.sw.sw_mdcp_kp_uwagi2 = self.sw.sw_mdcp_kp_uwagi2 + "spełniają warunki przepisów §79, ust. 5 i 6 \n"
		elif self.sw.sw_mdcp_ust5_str == "1" and self.sw.sw_mdcp_ust6_str == "0":
			self.sw.sw_mdcp_kp_uwagi2 = self.sw.sw_mdcp_kp_uwagi2 + "spełniają warunki przepisów §79, ust. 5 \n"	
		elif self.sw.sw_mdcp_ust5_str == "0" and self.sw.sw_mdcp_ust6_str == "1":
			self.sw.sw_mdcp_kp_uwagi2 = self.sw.sw_mdcp_kp_uwagi2 + "spełniają warunki przepisów §79, ust. 6 \n"	
		else:
			self.sw.sw_mdcp_kp_uwagi2 = self.sw.sw_mdcp_kp_uwagi2 + "nie spełniają warunków przepisów §79, ust. 5 i 6 \n"	
